...
def multiple_objectives(device="cuda:0", numberOfFrames=500):
    model = models.resnet18(pretrained=True)

    # visualize full channel
    obj1 = ChannelObjective(lambda m: m.layer3[1].conv2, channel=17)
    # visualize single (center) neuron in this channel
    obj2 = ConvNeuronObjective(lambda m: m.layer3[1].conv2, channel=13)
